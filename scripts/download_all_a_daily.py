...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    ...
    parser.add_argument("--download-engine", choices=["trend", "openbb"], default="trend", help="下载引擎")
    parser.add_argument("--provider", default="", help="数据源；trend 可填 akshare/tdx，openbb 默认可填 akshare")
